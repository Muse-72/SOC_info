...
u8 CAN1_Mode_Init(u8 tsjw, u8 tbs2, u8 tbs1, u16 brp, u8 mode)
{
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh = 0x068C << 5;				 ////16位ID
	CAN_FilterInitStructure.CAN_FilterIdLow = 0x1111;
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh = 0x00AC << 5;				 // 16位ID
	CAN_FilterInitStructure.CAN_FilterIdLow = 0x0269 << 5;
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = 0x0373 << 5; 
	CAN_FilterInitStructure.CAN_FilterMaskIdLow = 0x0268 << 5;
